from mht.legacy_mht.scripts.LLM_scripts.multilanguage_generation.generate_multilang_mGPT import gen_multilang_sentence
from mht.legacy_mht.scripts.LLM_scripts.english_generation.generate_english_gpt2_medium import gen_en_sentence
from mht.legacy_mht.scripts.LLM_scripts.post_processing import claw_english_processing, claw_hebrew_processing
...
def claw_exercise(lippath: str, word_ll: str = None, word_ul: str = None) -> tuple[str, str]:
    ...
    if flag_success:
        ...
        print(f"Translation in claw: {translation}")

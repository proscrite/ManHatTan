...
class MultipleAnswerScreen(gui.BaseExerciseScreen):
    ...
    def build_ui(self):
        ...
        self.optMenu = gui.GridLayout(cols=1, rows=4, size_hint_x=0.25,
        ...
        self.correction = gui.CorrectionDialog(self.answer, self.question)
        self.optMenu.add_widget(self.correction)

...
from mht.legacy_mht.scripts.ML_duolingo.duolingo_hlr import *
from mht.legacy_mht.scripts.python_scripts.update_lipstick import rebag_team
from mht.legacy_mht.gui.config_utils import set_logging_and_kivy_config
...
class MainMenuScreen(gui.Screen):
    ...
    def _add_lower_panel(self):
        ...
        print(f'self.ui_language = {self.ui_language}, self.learning_language = {self.learning_language}')
    ...
    def go_to_claw(self, instance):
        if not self.manager.has_screen("claw"):
            from mht.legacy_mht.gui.screen_claw import ClawScreen  # Import here to avoid loading at startup

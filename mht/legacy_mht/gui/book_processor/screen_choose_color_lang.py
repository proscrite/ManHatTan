...
import pandas as pd
import asyncio
from mht.legacy_mht.gui.book_processor.kivy_cadera_DfWidget import DfguiWidget, HoverBehavior
from mht.legacy_mht.scripts.python_scripts.bulkTranslate import find_language, bulkTranslate_main

from mht.legacy_mht.gui.common import COLOR_MAP, DEFAULT_COLOR

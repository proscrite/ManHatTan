...
from mht.legacy_mht.gui.book_processor.screen_choose_color_lang import ChooseColorLangScreen
from mht.legacy_mht.gui.common import PATH_KINDLES, PATH_PLAYBOOKS, PATH_GOOGLE_TRANSL
from glob import glob
import pandas as pd
import os

from mht.legacy_mht.scripts import krahtos_main, rashib_main, gost_main, make_lang_dic
...
class SelectBookScreen(gui.Screen):
    ...
    def proceed_to_show_gost(self):
        ...
        from mht.legacy_mht.gui.book_processor.screen_show_DB import ShowDBScreen

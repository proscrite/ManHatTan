...
from mht.legacy_mht.gui.book_processor.kivy_cadera_DfWidget import DfguiWidget
from mht.legacy_mht.scripts.python_scripts.bulkTranslate import find_language
